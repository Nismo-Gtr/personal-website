...
componentDidMount() {
    anime({
        targets: 'Capa_1 path, Capa_1 g path',
        scale: 1,
        duration: 2000,
        rotate: 1080
    })
    ...
    render() {
        return (
            <div>
                <svg version="1.1" id="Capa_1" scale="0" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	            viewBox="0 0 53 53" style="enable-background:new 0 0 53 53;" xmlSpace="preserve">
